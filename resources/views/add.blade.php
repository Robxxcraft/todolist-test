        ...
        <div class="p-8 tracking-wide">
          <section>
            <div class="text-xl font-bold text-gray-600">
              ...
              <form class="w-full mx-auto md:px-8 py-4 mt-4" action="/list/add" method="POST">
                @csrf
                  <div class="flex w-full flex-wrap px-0 md:px-8  flex-col">
                      <div class="flex-2 text-left mb-6">
                        ...
                        <input name="title" class="mt-2 transition w-full bg-gray-50 text-gray-700 border-2 border-gray-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:border-blue-300" type="text">
                        @error('title')
                    ...
                    @enderror 
                      ...
                      <div class="flex-2 text-left mb-6">
                        ...
                        <input class="appearance-none mt-2 transition w-full bg-gray-50 text-gray-700 border-2 border-gray-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:border-blue-300" name="detail" type="text">
                      </div>
                      <div class="flex-1 text-right">
                        <button class="text-white tracking-wide bg-blue-500 py-2 px-3 rounded text-sm shadow-sm transition focus:outline-none hover:bg-blue-600 hover:shadow-lg" type="submit">Create</button>
                      </div>
                  </div>
              </form>
          </section>
    ...
    <div class="basis-1/4 bg-gray-50 border-l">
        <div class="p-8 tracking-wide">
            ...
            <div class="tracking-wider mt-8">
                <a href="/login">
                    <div class="bg-blue-500 py-2 px-4 shadow-sm rounded-sm text-center px-4">
