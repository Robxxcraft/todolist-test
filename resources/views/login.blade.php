    ...
    <main class="bg-white max-w-lg mx-auto px-8 py-auto md:rounded md:shadow-2xl h-screen md:h-full relative">
        <section class="pt-8">
            <header class="mx-8 flex justify-center items-center text-blue-500">
                ...
                <div class="ml-2 text-2xl font-bold  text-center">Login</div>
            </header>
        ...
        <section class="mt-10">
            <form action="/login" method="POST">
                ...
                <div>
                    ...
                    <input type="email" name="email" autocomplete="true" class="bg-gray-100 py-2 mb-2 rounded w-full text-gray-700 focus:outline-none border-2 focus:border-blue-300 transition duration-300 px-3 pb-3">
                    @error('email')
        ...
        <p class="text-gray-500">Don't have an account? <a href="/register" class="cursor-pointer font-bold text-blue-500 hover:underline">Register</a>.</p>
    </div>
